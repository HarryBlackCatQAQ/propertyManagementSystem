...
CREATE TABLE `building`  (
  ...
  `propertyUid` bigint(20) NULL DEFAULT NULL COMMENT '所属楼盘Uid',
...
-- Records of building
-- ----------------------------
INSERT INTO `building` VALUES (1, 'test', NULL, NULL, NULL, 1, 6666, NULL);
INSERT INTO `building` VALUES (2, 'hovees', NULL, NULL, NULL, 2, 6666, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '楼盘表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of property
-- ----------------------------
INSERT INTO `property` VALUES (1, '翠湖香山', '广东省珠海市香洲区', 1234);
...
INSERT INTO `user` VALUES (2, 'test', 'test', '$2a$10$w79UYbBnJuLILvKaUoKUse8d/n3aMBzYw86uuP/ciy4w2E6QtWugq', 0);
