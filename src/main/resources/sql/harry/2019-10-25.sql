...
CREATE TABLE `complaint_and_suggestion_sheet` (
  ...
  `message` varchar(2555) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '投书建议单内容(备注)',
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='投诉建议单 表';
...
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8 COMMENT='投诉建议表的时间表';
...
CREATE TABLE `house_fee_record` (
  ...
  `outTradeNo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '支付单号',
  `payType` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '支付方式',
  PRIMARY KEY (`id`) USING BTREE
